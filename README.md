...
│ └── js/ # Scripts JS fuente
├── scss
│ ├── base/ # Variables, mixins, resets
│ ├── layout/ # Estilos de estructura general
│ └── app.scss # Archivo principal de estilos
├── video/ # Archivos de video del sitio
├── build # Archivos procesados (output de Gulp)
│ ├── css/
│ ├── img/
│ └── js/
├── built\css # Salida alternativa CSS (puede ser temporal o de prueba)
├── dist\css # CSS final listo para producción
